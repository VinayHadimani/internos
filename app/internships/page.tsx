        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl text-[#777]">Searching thousands of sources...</span>
            </div>
            <span className="text-[#555] text-sm text-center max-w-sm">We're performing a deep scrape across multiple platforms. This may take up to 20 seconds.</span>
          </div>
        )}
